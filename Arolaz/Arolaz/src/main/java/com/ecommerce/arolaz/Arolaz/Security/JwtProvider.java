package com.ecommerce.arolaz.Arolaz.Security;
...
public class JwtProvider {
    ...
    public String createToken(Optional<SecurityUser> securityUser, List<SecurityRole> roles) {
        ...
        Claims claims = Jwts.claims().setSubject(securityUser.get().getFirstName());
        ...
        token = Jwts.builder()
                .setClaims(claims)
                .claim("phone", securityUser.get().getPhone())
                .claim("name",securityUser.get().getFirstName())
